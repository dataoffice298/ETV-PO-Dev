report 50177 "Sub Store Transfer"
{
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = All;
    Caption = 'Sub Store Transfer_50177';
    ProcessingOnly = true;
        ...
        dataitem("Transfer Header"; "Transfer Header")
        {
            dataitem("Transfer Line"; "Transfer Line")
            {
                ...
                begin
                    ...
                    ExcelBuffer1.AddColumn('Receipt Date', FALSE, '', TRUE, FALSE, TRUE, '', ExcelBuffer1."Cell Type"::Text);
                    ExcelBuffer1.AddColumn('Receipt Status', FALSE, '', TRUE, FALSE, TRUE, '', ExcelBuffer1."Cell Type"::Text);
